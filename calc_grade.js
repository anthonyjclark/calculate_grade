...
function print() {
    console.log("\n" + yourClass.string);
    console.log("*************************************************************************");
    console.log("Category     Your Score   Percent%");
    console.log("-----------------------------------");
    ...
    console.log("-----------------------------------");
    console.log("Current Score:             " + yourClass.getCurrentScore().toPrecision(4) + "%");
    console.log("Weighted Score:            " + yourClass.getWeightedScore().toPrecision(4) + "%");
    console.log("*************************************************************************");
    console.log("\nNOTE:\n"
    ...
    for (const [name, category] of yourClass.map) {
        ...
        console.log(title + category.weight + "%" + ifIncomplete);
    }
}
